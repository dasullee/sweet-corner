    ...
    return (
        <div>
            <div className="containerServices">
                ...
                <img className="sideDotsServices" src={require('../../assets/images/dots-box1.png')}></img>
                <img className="side" src={require('../../assets/images/strips1.png')}></img>
            </div>
            <img className="bottom" src={require('../../assets/images/box2.png')}></img>
        </div>
    )
}